    ...
    <footer className="bg-white border-t border-slate-200 pt-16 pb-12 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div>
            <h4 className="text-sm font-bold text-slate-900 uppercase tracking-widest mb-6">About Us</h4>
          ...
          <div>
            <h4 className="text-sm font-bold text-slate-900 uppercase tracking-widest mb-6">Customer Support</h4>
            <ul className="space-y-4">
        ...
        <div className="border-t border-slate-200 py-10 flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="pt-8 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-medium text-slate-400 uppercase tracking-widest">
          <p>© 2024 Fluxify Inc. All rights reserved.</p>
