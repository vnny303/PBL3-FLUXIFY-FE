...
export default function Home() {
  const { handleQuickAdd } = useAppContext();
      ...
      <section className="mb-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            { id: 103, cat: 'Accessories', name: 'Minimalist Watch', price: '$250.00', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBDBh78YIKmnUbhgV6bfMn1CCLAPvwTg8qdChlDXs-hXMdWAk62MCLK07aRjO-eihUgS1Dx6CEjStEcD7zC6LuY3LyMoXNjMxIAno9yIFr_NPNqYd1RZ33k4X3-a8uxjGOBrAKC-EkYbqJ15s1HfjpzTNhuL95VCw8gP6_otuUKMXyMF06iw6SY7jfMKzITHApXxP2UHROXpMpODmgWn183KFLXwT2Mzq5BY0HqvVeKKRgswlnzUoz2gunbg1Lk8VlcLXdLfTDNAVc' },
            { id: 104, cat: 'Tech', name: 'Studio Microphone', price: '$175.00', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDrIeHdjuI6-2DcYWN68Vrdhdom0srfKhxyjWraAWmb4iHUXRCynpfZrzGhJB1INQnrEKKvtpWiPZ-ZawQBmi-bl9zrZKDqaDHjhShzCbsx4ioqyaLM-V-o_8bvOXQ-geH3ov1kY1ixRomTJ5gzTn4bR6IuO18MQVQkLZWe0OQ0cVFdH51sPBm0z0llWaQwU56iQaQ_6i0vqX0NNnBdR5NoESd-K41SpHurtUDXLpj1JKVjcFfxl5em_wxTUBRM4sF4IsO-DdqQYWA' }
          ].map((item, i) => (
