...
const baseProducts = [
  ...
  },
  {
    ...
    imgUrls: [
      ...
      'https://images.unsplash.com/photo-1542328863-b98a4cec82c7?auto=format&fit=crop&w=800&q=80',
      'https://images.unsplash.com/photo-1509631179647-0177331693ae?auto=format&fit=crop&w=800&q=80',
    ],
    skus: [
      { id: 'sku-003-1', productId: 'prod-003', price: 79.99, stock: 10, attributes: { color: 'Navy',  size: 'M'   }, imgUrl: 'https://images.unsplash.com/photo-1556821840-3a63f15732ce?auto=format&fit=crop&w=300&q=80' },
      { id: 'sku-003-2', productId: 'prod-003', price: 79.99, stock: 8,  attributes: { color: 'Navy',  size: 'L'   }, imgUrl: 'https://images.unsplash.com/photo-1556821840-3a63f15732ce?auto=format&fit=crop&w=300&q=80' },
      { id: 'sku-003-3', productId: 'prod-003', price: 79.99, stock: 6,  attributes: { color: 'Gray',  size: 'M'   }, imgUrl: 'https://images.unsplash.com/photo-1542328863-b98a4cec82c7?auto=format&fit=crop&w=300&q=80' },
      { id: 'sku-003-4', productId: 'prod-003', price: 84.99, stock: 5,  attributes: { color: 'Gray',  size: 'XL'  }, imgUrl: 'https://images.unsplash.com/photo-1542328863-b98a4cec82c7?auto=format&fit=crop&w=300&q=80' },
  ...
  },
  {
    ...
    imgUrls: [
      'https://images.unsplash.com/photo-1562886812-42f5ba8c1fb4?auto=format&fit=crop&w=800&q=80',
      'https://images.unsplash.com/photo-1508766206392-8bd5cf550d1c?auto=format&fit=crop&w=800&q=80',
    ],
    skus: [
      { id: 'sku-007-1', productId: 'prod-007', price: 34.99, stock: 15, attributes: { size: 'S'  }, imgUrl: 'https://images.unsplash.com/photo-1562886812-42f5ba8c1fb4?auto=format&fit=crop&w=300&q=80' },
      { id: 'sku-007-2', productId: 'prod-007', price: 34.99, stock: 18, attributes: { size: 'M'  }, imgUrl: 'https://images.unsplash.com/photo-1562886812-42f5ba8c1fb4?auto=format&fit=crop&w=300&q=80' },
      { id: 'sku-007-3', productId: 'prod-007', price: 34.99, stock: 12, attributes: { size: 'L'  }, imgUrl: 'https://images.unsplash.com/photo-1562886812-42f5ba8c1fb4?auto=format&fit=crop&w=300&q=80' },
      { id: 'sku-007-4', productId: 'prod-007', price: 34.99, stock: 8,  attributes: { size: 'XL' }, imgUrl: 'https://images.unsplash.com/photo-1562886812-42f5ba8c1fb4?auto=format&fit=crop&w=300&q=80' },
    ],
  },
  {
    id: 'prod-008',
