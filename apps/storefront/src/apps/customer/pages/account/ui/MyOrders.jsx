  ...
  if (orders.length === 0) {
    return (
      <section className="flex-1 space-y-6">
        ...
        <div 
          className="rounded-xl shadow-xl shadow-slate-200/50 border border-slate-100 p-10 flex flex-col items-center text-center"
  ...
  return (
    <section className="flex-1 space-y-6">
      ...
      {displayedOrders.map((order) => (
        <div 
          key={order.id} 
          className="rounded-xl shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden"
          style={{ backgroundColor: cardBg, color: textColor }}
        >
          <div className="p-6">
